...
ld -m elf_i386 --no-warn-rwx-segments -T src/linker.ld -o isodir/boot/myos.bin boot.o interrupts.o kernel.o gdt.o idt.o isr.o pic.o shell.o timer.o paging.o memory.o
